...
class _BoxDetailScreenState extends ConsumerState<BoxDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final tasksAsync = ref.watch(tasksByBoxProvider(widget.box.id));
                    ...
                    ...todo.map(
                      (task) => TaskItem(
                        ...
                        onToggle: () async {
                          ...
                          ref.invalidate(tasksByBoxProvider(widget.box.id));
                        },
  ...
  Future<void> _addTask() async {
    ...
    final nextSort = await isar.taskModels.filter().boxIdEqualTo(widget.box.id).count();
